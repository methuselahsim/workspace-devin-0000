...
char *std_kbdbufferFilename_H = "disk[0000]/0000000000000101.pro";
 ...
 int stdSizeupMultiple = 1; // can use 2 get w/e size fs u want
 //as long as its just a "2x or 8x ,x64 or w/e"🤔️
 // run a fx on startup 2 set in each file. (instead of hunting down)☝️
