...
global_inode_ct = STD_writeToInodes_H( filename_arg,local_AsciiBuffer_1, i , global_inode_ct);
...
//free(stdBlockBuffer_1);
 ...
 int STD_writeToInodes_H(char *filename_arg, char *local_AsciiBuffer_1, int iCount , int global_inode_ct){
 
 int fd ; 
 
 int nodeLimit = ((stdBlockSize_H / stdKbdAsciiSize_H) * global_inode_ct) -1;
